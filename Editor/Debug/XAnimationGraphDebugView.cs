...
namespace XAnimationEditor
{
    internal sealed class XAnimationGraphDebugView : VisualElement
    {
        ...
        private void RefreshDetails()
        {
            ...
            AddDetailsRow("State Speed", FormatFloat(m_SelectedNode.stateSpeed));
            AddDetailsRow("Global Speed", FormatFloat(m_SelectedNode.globalSpeed));
            AddDetailsRow("Final Speed", FormatFloat(m_SelectedNode.speed));
